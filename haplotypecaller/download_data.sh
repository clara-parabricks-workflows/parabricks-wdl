...
downloads=(
    "${test_data_base_path}/illumina/bam/test2.paired_end.recalibrated.sorted.bam|${DATA_DIR}|haplotypecaller_sample.bam"
    "${test_data_base_path}/genome/chr21/sequence/genome.fasta|${REF_DIR}|haplotypecaller_ref.fasta"
)
